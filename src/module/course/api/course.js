...
export const getCourseBaseById = (couseId) => {
  return http.requestQuickGet(apiUrl + '/course/coursebase/get/' + couseId)
}
...
export const updateCourseMarket = (courseId, parmas) => {
  return http.requestPut(apiUrl + '/course/coursemarket/update/' + courseId, parmas)
}
